        ...
        <div className="col-5" style={{
          ...
          <CardBg pad="32">
            <div className="sign-up-form-outer-div pt-2">
              <div className="sign-up-form-inner-div">
                ...
                <div className="sign-up-form-text text-center">
                  <span className="color-5C6D8E"> New to Company?</span>{" "}
                ...
                {otp ? (
                  <>
                    <Form.Group
                      className="mb-3 mt-4 animate__animated  animate__fadeInUp"
            ...
            <div className="other-signin-outer row">
              <div className="col-5 google">
                <AiFillGoogleCircle /> <span>Google</span>
              </div>
              <div className="col-5 google">
                <AiFillGoogleCircle /> <span>FaceBook</span>
              </div>
              <div></div>
            </div>
          </CardBg>
